(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('react-dom'), require('glam'), require('raf-schd'), require('react-view-pager'), require('react-focus-on'), require('react-full-screen'), require('a11y-focus-store'), require('react-transition-group')) :
	typeof define === 'function' && define.amd ? define(['react', 'react-dom', 'glam', 'raf-schd', 'react-view-pager', 'react-focus-on', 'react-full-screen', 'a11y-focus-store', 'react-transition-group'], factory) :
	(global.Images = factory(global.React,global.ReactDOM,global.glam,global.rafScheduler,global.PageView,global.FocusOn,global.Fullscreen,global.focusStore,global.Transition));
}(this, (function (React,reactDom,glam,rafScheduler,reactViewPager,reactFocusOn,Fullscreen,focusStore,reactTransitionGroup) { 'use strict';
